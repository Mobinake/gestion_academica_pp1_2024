...
from .models import Usuario, Matricula, Materia, matricula_materia, tipo_evaluacion, Metodologia, Evaluacion, Horario, Noticias
...
class NoticiasAdmin(admin.ModelAdmin):
    list_display = ('id_noticia', 'titulo', 'fecha', 'id_usuario')
    list_filter = ['fecha', 'id_usuario']
    search_fields = ['id_noticia', 'titulo', 'fecha', 'id_usuario']
