...
#     name_carrera = models.CharField(max_length=50, default=None)
#     facultad = models.CharField(max_length=50, default=None)
#     class Meta:
#         db_table = 'career'
...
#     def __str__(self):
#         return f'{self.id_carrera} - {self.name_carrera}'
#
# class Estudiante(models.Model):
#     id_estudiante = models.BigAutoField(primary_key=True, auto_created=True)      #identificador unico definido por el sistema
#     ci_estudiante = models.ForeignKey('Person', on_delete=models.CASCADE)
#     id_carrera = models.ForeignKey('Career', on_delete=models.CASCADE)
#     estado = models.BooleanField(default=True)
#     assistance = models.BooleanField(default=False)
#     behaviour = models.CharField(max_length=200, blank=True, default=None)
#     class Meta:
#         db_table = 'student'
...
class Materia(models.Model):
    ...
    nombre = CharField(max_length=50, blank=False)
    def __str__(self):
        return self.nombre
